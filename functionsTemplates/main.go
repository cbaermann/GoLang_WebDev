...
func init() {
	//template new gives back pointer to template
	//func gives pointer to template, passes in fm which holds "uc" and "ft"
	//ParseFiles gives pointer to template and error
